...
MainAI = MainSiteHTML(
    ...
    arrangement="pages",
    output_tag="article",
    output_attrs={"class": "wp-block-group post post--result is-layout-flow wp-block-group-is-layout-flow"},
    ...
    date_tag="time", date_attrs={"datetime": "2024-11-01T00:00:00+00:00"},
    title_tag="h2", title_attrs={"class": "post-title wp-block-post-title"},
    excerpt_tag="div", excerpt_attrs={"class": "post-excerpt wp-block-post-excerpt"},
    sele=False
)
OutputAI = OutputSiteHTML(topics_attrs={"class": "wp-block-list-item"},
                          topics_tag="li",
                          pdf_tag="object",
                          pdf_attrs={
...
MainPOL = MainSiteHTML(
    url_head="https://www.amnesty.org.pl/szukaj/page/",
...
MainHUNGARY = MainSiteHTML(
    url_head="https://www.amnesty.org/en/latest/campaigns/page/",
    source_name="AI Hungary",
    arrangement="pages",
    output_tag="article",
    output_attrs={"class": "wp-block-group aimc-ignore is-layout-flow wp-block-group-is-layout-flow"},
    link_in_out_tag=False,
    # Used to be tag "a" and class "floating-anchor"
    link_tag="a", link_attrs={},
    link_prefix="",
...
OutputHUNGARY = OutputSiteHTML(topics_attrs={"class": "wp-block-list-item"},
                          topics_tag="li",
                          pdf_tag="a",
                          pdf_attrs={
